export default {
  ...
  trade: {
    ...
    noTrades: 'Aucune transaction trouvée'
  },
  dashboard: {
  ...
  home: {
    ...
    feature1: {
      ...
      description: 'Visualisez les tendances du marché et prenez des décisions éclairées grâce à nos outils d\'analyse avancés.'
    },
    feature2: {
      title: 'Transactions automatisées',
      description: 'Configurez des règles d\'achat et de vente automatiques basées sur vos stratégies personnalisées.'
    },
    feature3: {
    ...
    cta: {
      ...
      description: 'Créez un compte gratuitement et découvrez comment CryptoTradeBot peut transformer votre expérience de trading.',
